...
public class Callback : PageModel
{
    ...
    public async Task<IActionResult> OnGet()
    {
        ...
        var client1UserId = response.Claims.FirstOrDefault(c => c.Type == "Client1_UserId");
        
        if (client1UserId == null || client1UserId.Value == null)
        {
        ...
        var user = _users.FindBySubjectId(client1UserId.Value);
